                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      {task.photoUrl ? (
                        <div className="mt-3">
                            ...
                            <a href={task.photoUrl} target="_blank" rel="noopener noreferrer" className="inline-block group">
                                <img 
                                    src={task.photoUrl} 
                                    alt="Prova" 
                                    className="w-40 h-40 object-cover rounded-lg border border-gray-200 group-hover:shadow-lg transition-all"
                                />
                            </a>
                        </div>
                      ) : (
